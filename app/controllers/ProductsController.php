...
class ProductsController extends ControllerBase
{
    ...
    public function editAction($id)
    {
        if (!$this->request->isPost()) {
            ...
            $this->tag->setDefault("product_name", $product->product_name);
            $this->tag->setDefault("price", $product->price);
            $this->tag->setDefault("sale", $product->sale);
    ...
    public function createAction()
    {
        ...
        $product->product_name = $this->request->getPost("product_name");
...
//        $product->sale = $this->request->getPost("sale");
    ...
    public function saveAction()
    {
        ...
        $product->productName = $this->request->getPost("product_name");
        $product->price = $this->request->getPost("price");
        $product->sale = $this->request->getPost("sale");
